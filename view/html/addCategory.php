...
<!-- Header -->
  ...
  <main class="content">
    ...
    <form action="/save-category" method="post">
      ...
      <div class="input-field">
        <label for="product_id" class="label">Category Code</label>
        <input type="text" id="product_id" name="product_id" class="input-text" value="1"/>
        
      </div>
      <div class="actions-form">
        <a href="/dashboard" class="action back">Back</a>
        <button class="btn-submit btn-action">Save Category</button>
      </div>
    </form>
  </main>
</body>
