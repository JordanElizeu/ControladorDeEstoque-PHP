...
<!-- Header -->
  ...
  <main class="content">
    ...
    <div class="infor">
      You have <?= count($listCategories); ?> products added on this store: <a href="/addProduct" class="btn-action">Add new Product</a>
    </div>
    <ul class="product-list">
      ...
      <li>
        ...
        <div class="product-info">
          ...
          <div class="product-price"><span class="special-price"><?= $product->getQuantity(); ?> available</span> <span>R$<?= $product->getPrice(); ?></span></div>
        </div>
      </li>
        <?php endforeach; ?>
    </ul>
